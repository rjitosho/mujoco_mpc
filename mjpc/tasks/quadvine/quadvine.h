...
#ifndef MJPC_TASKS_QUADVINE_QUADVINE_H_
#define MJPC_TASKS_QUADVINE_QUADVINE_H_
 ...
 public:
  ...
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    ...
    explicit ResidualFn(const Quadvine* task) : mjpc::BaseResidualFn(task) {}
...
#endif  // MJPC_TASKS_QUADVINE_QUADVINE_H_
